...
CREATE TABLE IF NOT EXISTS users (
    ...
    user_profile_id INTEGER FOREIGN KEY
);

CREATE TABLE IN NOT EXISTS user_profile (
...
CREATE TABLE IN NOT EXISTS pages (
...
CREATE TABLE IN NOT EXISTS page_meta_data (
...
CREATE TABLE IN NOT EXISTS images_portfolios (
